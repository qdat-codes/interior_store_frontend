      ...
      <div className=" relative w-full min-h-[300px] bg-[url('/images/footer_background.jpg')] bg-cover bg-center text-[#FBF7F1] ">
        ...
        <div className="relative z-10">
          <div className=" lg:px-[165px] ">
            <div className="lg:py-[62px]">
              <Image
                src={logo}
                className="lg:w-[100px] lg:h-[100px] rounded-sm cursor-pointer object-cover transition-transform hover:scale-105 active:scale-95 duration-300 lg:mb-[18px]"
              />
              ...
              <div className=" lg:flex justify-between items-center ">
                <div className="flex flex-col justify-start items-start space-y-[18px] lg:max-w-[430px]">
                  ...
                  <div className="flex">
                    ...
                    <div className="mr-8">
                      <p className="lg:text-[16px] font-bold">Liên hệ</p>
                    ...
                    ></Icon>
                    <div>
                      <p className="lg:text-[16px] font-bold">Email</p>
                      <p className="lg:text-[14px] font-normal">
                  ...
                  <div className="flex">
                    ...
                    <div className="mr-8">
                      <p className="lg:text-[16px] font-bold">Showroom</p>
                      <p className="lg:text-[14px] font-normal">
                ...
                <div className="-mt-20">
                  <p className="mb-2 text-[16px] font-bold text-[#FFFFF]">
                    Thông tin
                  </p>
          ...
          <div className="lg:px-[165px] flex justify-between items-center pb-[23px]">
            ...
            <p>© 2025 HomeDesign. All Rights Reserved</p>
          </div>
        </div>
      </div>
    </>
